 ...
 * with the array of results, if all values have been resolved, or else rejects.
 *
 ...
 * similar to `promise.settle`, adding comprehensive details in case of a reject.
 *
 * @param {Array} values
 ...
 *
 * @param {Function} [cb]
 * Optional callback to receive the result for each value.
 *
 * Parameters:
 ...
 * while the rejected value is reported as object `{success, result, origin}`:
 *  - `success` = `false`
