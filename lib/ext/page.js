 ...
 * Returning nothing (`undefined`) or an empty array indicates the end of the sequence.
 *
 * The function is called with the same `this` context as the calling method.
 *
 * Parameters:
 *  - `index` - index of the page being requested
 *  - `data` - result from the previously returned page, resolved as a $[batch] (`undefined`
 *  when `index=0`)
 *
 * @param {function} [dest]
