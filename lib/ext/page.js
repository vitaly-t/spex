 ...
 *
 * Expected to return a $[mixed value] that resolves with next page of data (array of $[mixed values]).
 * Returning a value that resolves into `undefined` ends the sequence, and the method resolves.
 *
 ...
 * `undefined`, or when an error/reject occurs.
 *
 * @returns {Promise}
 *
