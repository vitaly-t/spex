 ...
 *
 * The function can optionally return a promise object, if data processing is done asynchronously.
 ...
 *
 * @returns {Promise}
 * When successful, it resolves with data depending on parameter `track`. When `track` is `false`
