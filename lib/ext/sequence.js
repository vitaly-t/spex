 ...
 *
 * Passing in anything other than a function will throw error `Invalid sequence source.`.
 *
 * @param {function} [dest]
 * Optional destination function (notification callback), to receive each resolved data,
 * process it and respond as required.
 *
 * Function parameters:
 *  - `index` - index of resolved data in the sequence
