 ...
 * @param {function} source - a function that creates and returns a new mixed value
 * to be resolved. Returning nothing/`undefined` indicates the end of the sequence.
 *
