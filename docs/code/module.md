## Modules
<dl>
<dt><a href="#module_spex">spex</a> ⇒ <code>Object</code></dt>
<dd><p>Attaches to an external promise library and provides additional methods built solely
on the basic promise operations:</p>
<ul>
<li>construct a new promise with a callback function</li>
<li>resolve a promise with some result data</li>
<li>reject a promise with a reason</li>
</ul>
<h3 id="usage">usage</h3>
<p>For any third-party promise library:</p>
<pre><code class="language-javascript">var promise = require(&#39;bluebird&#39;);
var spex = require(&#39;spex&#39;)(promise);
</code></pre>
<p>For ES6 promises:</p>
<pre><code class="lang-js">var spex = require(&#39;spex&#39;)(Promise);
</code></pre>
</dd>
<dt><a href="#module_spex">spex</a> : <code>main</code></dt>
<dd></dd>
</dl>
...
<table>
  ...
  <tbody>
<tr>
    <td>promiseLib</td><td><code>Object</code> | <code>function</code> | <code>PromiseAdapter</code></td><td><p>Instance of a promise library to be used by this module.</p>
...
<p>Alternatively, an object of type <a href="module:spex.PromiseAdapter">module:spex.PromiseAdapter</a> can be passed in, which
...
* [spex](#module_spex) : <code>main</code>
  * [~PromiseAdapter](#module_spex..PromiseAdapter)
    * [new PromiseAdapter(create, resolve, reject)](#new_module_spex..PromiseAdapter_new)
